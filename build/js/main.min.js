...
/* harmony import */ var _modules_about__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/about */ "./js/modules/about.js");
/* harmony import */ var _modules_form_setting__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/form-setting */ "./js/modules/form-setting.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_2__["setAccordion"])();
  Object(_modules_about__WEBPACK_IMPORTED_MODULE_3__["setAboutSecton"])();
  Object(_modules_form_setting__WEBPACK_IMPORTED_MODULE_4__["setForms"])();
  // ---------------------------------
...
/*!*****************************!*\
  !*** ./js/modules/about.js ***!
  \*****************************/
/*! exports provided: setAboutSecton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setAboutSecton", function() { return setAboutSecton; });
/* harmony import */ var _accordion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./accordion */ "./js/modules/accordion.js");

var ABOUT_BUTTON = 'data-about-bth';
var ABOUT_BUTTON_ACTIVE = 'data-about-btn-state';
var ABOUT_EXTRA_BLOCK = 'data-about-extra-information';
var ABOUT_BUTTON_JS_MODE = 'data-about-btn-js-mode';
var ACTIVE_STATE_BUTTON = 'active';
var INACTIVE_STATE_BUTTON = 'inactive';
var INACTIVE_NO_JS_MODE = 'true';
var aboutContainer = document.querySelector('.about');
var aboutButton = aboutContainer && aboutContainer.querySelector('.about__button');
var buttonShowLess = aboutButton && aboutButton.querySelector('.about__btn-less');
var buttonShowMore = aboutButton && aboutButton.querySelector('.about__btn-more');
var aboutExtraBlock = aboutContainer && aboutContainer.querySelector('.about__pharagraph-container--full');
var openAboutBlock = function openAboutBlock(trigerButton) {
  Object(_accordion__WEBPACK_IMPORTED_MODULE_0__["setAttributeValue"])(buttonShowMore, ABOUT_BUTTON_ACTIVE, INACTIVE_STATE_BUTTON);
  Object(_accordion__WEBPACK_IMPORTED_MODULE_0__["setAttributeValue"])(buttonShowLess, ABOUT_BUTTON_ACTIVE, ACTIVE_STATE_BUTTON);
  Object(_accordion__WEBPACK_IMPORTED_MODULE_0__["setAttributeValue"])(aboutExtraBlock, ABOUT_EXTRA_BLOCK, _accordion__WEBPACK_IMPORTED_MODULE_0__["OPEN_ATTRIBUTE_VALUE"]);
  Object(_accordion__WEBPACK_IMPORTED_MODULE_0__["setAttributeValue"])(trigerButton, ABOUT_BUTTON, _accordion__WEBPACK_IMPORTED_MODULE_0__["OPEN_ATTRIBUTE_VALUE"]);
};
var closeAboutBlock = function closeAboutBlock(trigerButton) {
  Object(_accordion__WEBPACK_IMPORTED_MODULE_0__["setAttributeValue"])(buttonShowLess, ABOUT_BUTTON_ACTIVE, INACTIVE_STATE_BUTTON);
  Object(_accordion__WEBPACK_IMPORTED_MODULE_0__["setAttributeValue"])(buttonShowMore, ABOUT_BUTTON_ACTIVE, ACTIVE_STATE_BUTTON);
  Object(_accordion__WEBPACK_IMPORTED_MODULE_0__["setAttributeValue"])(aboutExtraBlock, ABOUT_EXTRA_BLOCK, _accordion__WEBPACK_IMPORTED_MODULE_0__["CLOSE_ATTRIBUTE_VALUE"]);
  Object(_accordion__WEBPACK_IMPORTED_MODULE_0__["setAttributeValue"])(trigerButton, ABOUT_BUTTON, _accordion__WEBPACK_IMPORTED_MODULE_0__["CLOSE_ATTRIBUTE_VALUE"]);
};
var aboutButtonHandler = function aboutButtonHandler(button) {
  return function () {
    if (Object(_accordion__WEBPACK_IMPORTED_MODULE_0__["isOpenAtribute"])(button, ABOUT_BUTTON)) {
...
var setButtonHandler = function setButtonHandler(button, handler) {
  if (button) {
    button.addEventListener('click', handler(button));
  }
};
var setAboutSecton = function setAboutSecton() {
  Object(_accordion__WEBPACK_IMPORTED_MODULE_0__["setAttributeValue"])(aboutButton, ABOUT_BUTTON_JS_MODE, INACTIVE_NO_JS_MODE);
  Object(_accordion__WEBPACK_IMPORTED_MODULE_0__["setAttributeValue"])(aboutExtraBlock, ABOUT_EXTRA_BLOCK, _accordion__WEBPACK_IMPORTED_MODULE_0__["CLOSE_ATTRIBUTE_VALUE"]);
...
/*!*********************************!*\
  !*** ./js/modules/accordion.js ***!
  \*********************************/
/*! exports provided: setAccordion, isOpenAtribute, setAttributeValue, CLOSE_ATTRIBUTE_VALUE, OPEN_ATTRIBUTE_VALUE */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setAccordion", function() { return setAccordion; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isOpenAtribute", function() { return isOpenAtribute; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setAttributeValue", function() { return setAttributeValue; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CLOSE_ATTRIBUTE_VALUE", function() { return CLOSE_ATTRIBUTE_VALUE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OPEN_ATTRIBUTE_VALUE", function() { return OPEN_ATTRIBUTE_VALUE; });
var ATTRIBUTE_BUTTON = 'data-accordion-btn';
var ATTRIBUTE_BUTTON_NUMBER = 'data-accordion-btn-number';
var ATTRIBUTE_BLOCK = 'data-accordion-block';
var ATTRIBUTE_BLOCK_NUMBER = 'data-accordion-block-number';
var CLOSE_ATTRIBUTE_VALUE = 'close';
var OPEN_ATTRIBUTE_VALUE = 'open';
var accordionContainer = document.querySelector('.footer__lower-container');
var accordionButtons = accordionContainer && accordionContainer.querySelectorAll('.footer__btn-toggle');
var accordionBlocks = accordionContainer && accordionContainer.querySelectorAll('.footer__list');
...
var isTargetBlock = function isTargetBlock(block, blockNumber) {
  return block.getAttribute(ATTRIBUTE_BLOCK_NUMBER) === blockNumber;
};
var setAttributeValue = function setAttributeValue(element, attributeName, attributeValue) {
  return element.setAttribute(attributeName, attributeValue);
};
var getAttributeValue = function getAttributeValue(element, attributeName) {
  return element.getAttribute(attributeName);
};
var setAttributesToClose = function setAttributesToClose(elements, attributeName) {
  if (elements[0]) {
    elements.forEach(function (element) {
      return setAttributeValue(element, attributeName, CLOSE_ATTRIBUTE_VALUE);
    });
  }
};
var initialSetAccordionElements = function initialSetAccordionElements() {
  setAttributesToClose(accordionButtons, ATTRIBUTE_BUTTON);
  setAttributesToClose(accordionBlocks, ATTRIBUTE_BLOCK);
};
var setTurgetBlockAttribute = function setTurgetBlockAttribute(blocks, blockNumber, attributeValue) {
...
var buttonClickHandler = function buttonClickHandler(button) {
  return function () {
    var blockNumber = getAttributeValue(button, ATTRIBUTE_BUTTON_NUMBER);
...
var setElementsHandler = function setElementsHandler(elements, handler) {
  if (elements[0]) {
    elements.forEach(function (element) {
      return element.addEventListener('click', handler(element));
    });
  }
};
...
/***/ "./js/modules/form-setting.js":
/*!************************************!*\
  !*** ./js/modules/form-setting.js ***!
  \************************************/
/*! exports provided: setForms */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setForms", function() { return setForms; });
/* harmony import */ var _phone_input__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./phone-input */ "./js/modules/phone-input.js");
/* harmony import */ var _form_submit_btn__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./form-submit-btn */ "./js/modules/form-submit-btn.js");
...
var forms = document.querySelectorAll('.feedback__form');
...
var setForm = function setForm(form) {
  ...
  Object(_phone_input__WEBPACK_IMPORTED_MODULE_0__["setPhoneMask"])();
  Object(_form_submit_btn__WEBPACK_IMPORTED_MODULE_1__["srightModeForm"])(form, formButton);
};
var setForms = function setForms() {
  if (forms[0]) {
...
/***/ "./js/modules/form-submit-btn.js":
/*!***************************************!*\
  !*** ./js/modules/form-submit-btn.js ***!
  \***************************************/
/*! exports provided: srightModeForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "srightModeForm", function() { return srightModeForm; });
var FILLED_PHONE_INPUT_CLASS = 'feedback__input-phone-filled';
var UNFILLED_PHONE_INPUT_CLASS = 'feedback__input-phone-unfilled';
var addClass = function addClass(className, inputElement) {
  inputElement.classList.add(className);
};
var removeClass = function removeClass(className, inputElement) {
  inputElement.classList.remove(className);
};
var srightModeForm = function srightModeForm(form, submitBtn) {
  var phoneNumberInput = form && form.querySelector('.feedback__input--phone');
  phoneNumberInput.addEventListener('change', function (evt) {
...
var setPhoneMask = function setPhoneMask() {
  var phoneElements = document.querySelectorAll('.feedback__input--phone');
  var maskOption = {
  ...
  if (phoneElements[0]) {
    phoneElements.forEach(function (phoneElement) {
      return Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(phoneElement, maskOption);
    });
  }
};
